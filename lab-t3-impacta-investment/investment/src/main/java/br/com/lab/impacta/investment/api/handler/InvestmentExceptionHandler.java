...
public class InvestmentExceptionHandler {
    ...
    @ExceptionHandler(InvestmentAccountWithoutBalanceForProductPrivateInvestmentException.class)
    ...
    @ExceptionHandler(InvestimentAccountIsNotDebitedException.class)
